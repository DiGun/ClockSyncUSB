...
#define TM1637_OUT				PORTD
#define TM1637_IN				PIND

#define	TM1637_DIO_PIN			(1<<PORTD3)
#define	TM1637_CLK_PIN			(1<<PORTD4)
#define	TM1637_DELAY_US			(1)
#define	TM1637_DEFAULT_BRIGHTNESS	(4)
